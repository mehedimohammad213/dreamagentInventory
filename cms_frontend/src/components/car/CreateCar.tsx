...
const CreateCar: React.FC = () => {
  ...
  const navState = useNavigationState<{ prefilledChassisNo?: string; returnStockTab?: StockPageTab }>();
  const prefilledChassisNo = navState?.prefilledChassisNo;
