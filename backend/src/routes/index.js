...
router.post('/purchase-history', auth, wrapUpload(uploadPurchasePdfs), PurchaseHistoryController.store);
...
router.put('/purchase-history/:id', auth, wrapUpload(uploadPurchasePdfs), PurchaseHistoryController.update);
